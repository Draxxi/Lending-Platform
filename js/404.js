! function e(t, n, i) {
    ...
    4: [function() {
        ...
        function n(e) {
            ...
            function n() {
                a.ang = 0, o = shell404.range(1, 1.5), t()
            }
        ...
        var a = "Maxxos",
            ...
            d = "../box_bck.png",
            c = new function() {
                this.seedColor = [0, 255, 0], this.sideColor = [0, 128, 255], this.message = a, this.background = [30, 30, 30], this.pointColor = [153, 255, 255], this.ambientColor = [255, 153, 255], this.hsv = {}, this.explode = function() {
